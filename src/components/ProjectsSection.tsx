...
const PROJECTS: ProjectData[] = [
  {
    ...
    liveUrl: 'https://aroraitsolutations.netlify.app/',
    col1Image1: '/public/template/02.png',
    col1Image2: '/public/template/03.png',
    col2Image: '/public/template/01.png',
  },
  {
    number: '02',
    category: 'Freelancer',
    name: 'Rathi Lab',
    liveUrl: 'https://rathilab.com/',
    col1Image1: '/public/template/05.png',
    col1Image2: '/public/template/06.png',
    col2Image: '/public/template/04.png',
  },
  {
    number: '03',
    category: 'Freelancer',
    name: 'ICBTM Conference 2026',
    liveUrl: 'https://www.icbtmconference.com/',
    col1Image1: '/public/template/08.png',
    col1Image2: '/public/template/09.png',
    col2Image: '/public/template/07.png',
  },
  {
    number: '04',
    category: 'Freelancer',
    name: 'HE-CIT',
    liveUrl: 'https://he-cit.com/',
    col1Image1: '/public/template/11.png',
    col1Image2: '/public/template/12.png',
    col2Image: '/public/template/10.png',
  },
];
