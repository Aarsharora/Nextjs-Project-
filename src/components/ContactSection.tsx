...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'arsharora8107@gmail.com',
    href: 'mailto:arsharora8107@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: '+91 63674 08347',
    // wa.me requires digits only — no +, no spaces, no hyphens
    href: 'https://wa.me/916367408347',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/arsh-arora-08b1aa332',
    href: 'https://www.linkedin.com/in/arsh-arora-08b1aa332/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@Aarsharora',
    href: 'https://github.com/Aarsharora',
  },
];
      ...
      <FadeIn delay={0.4} y={20}>
        <div className="mx-auto mt-20 sm:mt-24 md:mt-28 flex max-w-5xl flex-col items-center gap-3 border-t border-[#D7E2EA]/10 pt-8 text-center sm:flex-row sm:justify-between">
          <span
            ...
            style={{ fontSize: 'clamp(0.7rem, 1.1vw, 0.9rem)' }}
          >
            © 2026 Arsh Arora. All rights reserved.
          </span>
          <span
            className="font-light uppercase tracking-widest text-[#D7E2EA]/50"
            style={{ fontSize: 'clamp(0.7rem, 1.1vw, 0.9rem)' }}
