...
const ABOUT_TEXT =
  "I'm a BCA final year student from MDSU Ajmer, currently i am looking for an internship opportunity in the field of software development, data science, or AI integration. I have a strong foundation in programming languages such as Python and JavaScript, and I am passionate about leveraging technology to solve real-world problems. With experience in frameworks like React and libraries such as Pandas and NumPy, I am eager to contribute my skills and learn from industry professionals. I am particularly interested in exploring the applications of AI and GenAI, and I am excited about the prospect of working on innovative projects that push the boundaries of technology.";
            ...
            <div className="flex flex-col gap-5 sm:gap-6">
              {[
                ...
                },
                {
                  ...
                  items: ['React', 'Tailwind', 'Node.js'],
                },
                {
                  label: 'Tools & Platforms',
                  items: ['Figma', 'Vercel', 'Git', 'GitHub', 'Canva'],
                },
                {
                  label: 'AI & GenAI',
                  items: ['Gemini', 'Claude', 'OpenAI', 'Prompt engineering', 'ChatGPT'],
                },
              ].map((group) => (
                <div
                  key={group.label}
